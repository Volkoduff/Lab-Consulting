...
function dimox_breadcrumbs() {
  ...
  $wrap_before = '<div class="about-wrap d-flex justify-content-center justify-content-lg-start" itemscope itemtype="http://schema.org/BreadcrumbList">'; // открывающий тег обертки
  ...
  $before = '<span class="about-wrap__text">'; // тег перед текущей "крошкой"
  ...
  $home_link = $link_before . '<a href="' . $home_url . '"' . $link_attr . ' class="home about-wrap__link">' . $link_in_before . $text['home'] . $link_in_after . '</a>' . $link_after;
